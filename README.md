(Για να δείτε φωτογραφίες και να διαβάσετε ή να δείτε σε γράφημα την πρόοδο του πρότζεκτ, παρακαλώ ανατρέξετε στο [Wiki](https://github.com/ellak-monades-aristeias/Kadoi-mpasketes/wiki).) 
