...
Το έργο απευθύνεται κυρίως στους μαθητές σχολείων. Η χρήση του ιδανικά θα γίνεται σε προάλυλιους χώρους σχολείου όπου οι μαθητές θα μπορούν να τους χρησιμοποιούν.Εάν αυτή η χρήση έχει τα αποτελέσματα που προβλέπονται, μπορεί να επεκταθεί και σε πλατείες και παιδικές χαρές.

Οι κοινότητες χρηστών/ developers θα μπορούσε να είναι φοιτητές τμημάτων του πανεπιστημίου όπως μηχανολόγοι ή αρχιτέκτονες ή ακόμα καλύτερα σπουδαστές τμημάτων βιομηχανικού design. Επίσης κοινότητες hackerspace και makerspace θα μπορούσαν επίσης να το βελτιώσουν και να το επεκτείνουν.

## Κόστος ##
Το έργο δεν έχει επιπλέον κόστη. Τα κόστη για 1,10,100 κομμάτια αναφέρονται στο παρακάτω Link:
https://github.com/ellak-monades-aristeias/Kadoi-mpasketes/blob/master/Files/Pinakas%20ylikwn%20se%20JPEG.jpg
